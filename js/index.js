...
(function () {
  ...
  ************************************************************ */
  ...
  function init(){
    ...
    gallerys[1] = new Gallery($('#sceneStories_1 .gallery'),$('#sceneStories_1 .thumbs'),flags,sceneColors[3]);
    //gallerys[2] = new Gallery($('#sceneColors .gallery'),$('#sceneColors .thumbs'),flags,sceneColors[4]);
    //gallerys[3] = new Gallery($('#sceneObject .gallery'),$('#sceneObject .thumbs'),flags,sceneColors[5]);
